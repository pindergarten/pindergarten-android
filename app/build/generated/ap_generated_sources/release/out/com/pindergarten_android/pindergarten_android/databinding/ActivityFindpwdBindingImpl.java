...
public class ActivityFindpwdBindingImpl extends ActivityFindpwdBinding  {
    ...
    public ActivityFindpwdBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private ActivityFindpwdBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten_android.pindergarten_android.FindPwdActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten_android.pindergarten_android.FindPwdActivity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.pindergarten_android.pindergarten_android.FindPwdActivity activity = mActivity;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.pindergarten_android.pindergarten_android.FindPwdActivity value;
        public OnClickListenerImpl setValue(com.pindergarten_android.pindergarten_android.FindPwdActivity value) {
            this.value = value;
