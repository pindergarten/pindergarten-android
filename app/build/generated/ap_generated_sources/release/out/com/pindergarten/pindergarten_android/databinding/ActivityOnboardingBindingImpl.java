...
public class ActivityOnboardingBindingImpl extends ActivityOnboardingBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten.pindergarten_android.OnboardingActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten.pindergarten_android.OnboardingActivity Activity) {
