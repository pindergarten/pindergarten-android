...
public class ActivityJoinBindingImpl extends ActivityJoinBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten.pindergarten_android.JoinActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten.pindergarten_android.JoinActivity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.pindergarten.pindergarten_android.JoinActivity activity = mActivity;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.pindergarten.pindergarten_android.JoinActivity value;
        public OnClickListenerImpl setValue(com.pindergarten.pindergarten_android.JoinActivity value) {
            this.value = value;
