...
public class ActivityFindpwd2BindingImpl extends ActivityFindpwd2Binding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten.pindergarten_android.FindPwd2Activity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten.pindergarten_android.FindPwd2Activity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.pindergarten.pindergarten_android.FindPwd2Activity activity = mActivity;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.pindergarten.pindergarten_android.FindPwd2Activity value;
        public OnClickListenerImpl setValue(com.pindergarten.pindergarten_android.FindPwd2Activity value) {
            this.value = value;
