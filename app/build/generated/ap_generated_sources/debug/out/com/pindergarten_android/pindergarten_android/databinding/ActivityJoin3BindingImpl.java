...
public class ActivityJoin3BindingImpl extends ActivityJoin3Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.notice, 10);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten_android.pindergarten_android.Join3Activity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten_android.pindergarten_android.Join3Activity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.pindergarten_android.pindergarten_android.Join3Activity activity = mActivity;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.pindergarten_android.pindergarten_android.Join3Activity value;
        public OnClickListenerImpl setValue(com.pindergarten_android.pindergarten_android.Join3Activity value) {
            this.value = value;
