...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten_android.pindergarten_android.SplashActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten_android.pindergarten_android.SplashActivity Activity) {
