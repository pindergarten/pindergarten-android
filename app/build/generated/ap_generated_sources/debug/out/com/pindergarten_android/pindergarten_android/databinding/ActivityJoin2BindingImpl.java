...
public class ActivityJoin2BindingImpl extends ActivityJoin2Binding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setActivity((com.pindergarten_android.pindergarten_android.Join2Activity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.pindergarten_android.pindergarten_android.Join2Activity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.pindergarten_android.pindergarten_android.Join2Activity activity = mActivity;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.pindergarten_android.pindergarten_android.Join2Activity value;
        public OnClickListenerImpl setValue(com.pindergarten_android.pindergarten_android.Join2Activity value) {
            this.value = value;
