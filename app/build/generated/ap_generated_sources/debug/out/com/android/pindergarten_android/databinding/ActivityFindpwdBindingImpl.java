...
public class ActivityFindpwdBindingImpl extends ActivityFindpwdBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.phoneNum, 6);
        sViewsWithIds.put(R.id.phone_info, 7);
        sViewsWithIds.put(R.id.sendNum, 8);
        sViewsWithIds.put(R.id.imageView4, 9);
        sViewsWithIds.put(R.id.vertifyNum, 10);
        sViewsWithIds.put(R.id.confirmBtn, 11);
        sViewsWithIds.put(R.id.nextBtn, 12);
