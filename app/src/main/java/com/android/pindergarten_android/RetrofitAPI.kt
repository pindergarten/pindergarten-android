...
interface RetrofitAPI {
    ...
    fun userPostAPI(@Header("x-access-token") value : String,@Path("userId") userId : Int): Call<Post?>?

    //사용자 펫 조회
    @GET("api/users/{userId}/pet")
    fun userPetSearchAPI(@Header("x-access-token") value : String,@Path("userId") userId : Int): Call<Post?>?
