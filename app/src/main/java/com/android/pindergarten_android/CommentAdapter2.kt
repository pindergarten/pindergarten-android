...
class CommentAdapter2(private val userImg:ArrayList<Uri>, private val userId:ArrayList<String>, private val userDetail:ArrayList<String>,private val userDate:ArrayList<String>, val context: Fragment_comment): RecyclerView.Adapter<CommentAdapter2.ViewHolder>(){
