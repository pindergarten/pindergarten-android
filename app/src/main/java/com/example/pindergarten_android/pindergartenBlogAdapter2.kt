...
class pindergartenBlogAdapter2(private val blogTitle:ArrayList<String>, private val blogDescription:ArrayList<String>, private val blogPostdate:ArrayList<String>, val context: Fragment_moreReview
): RecyclerView.Adapter<pindergartenBlogAdapter2.ViewHolder>(){
    ...
    fun setItemClickListener(itemClickListener: pindergartenBlogAdapter2.ItemClickListener) {
