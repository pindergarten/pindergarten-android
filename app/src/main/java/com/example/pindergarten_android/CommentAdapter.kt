...
class CommentAdapter(private val userImg:ArrayList<Uri>, private val userId:ArrayList<String>, private val userDetail:ArrayList<String>,private val userDate:ArrayList<String>, val context: Fragment_eventdetail): RecyclerView.Adapter<CommentAdapter.ViewHolder>(){
